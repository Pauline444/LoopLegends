document.addEventListener("DOMContentLoaded", () => {
    ...
    const contentContainer = document.querySelector(".interactive-content-container");
    ...
    function handlePostsClick(e) {
      ...
      if (window.currentUser) {
        ...
        contentContainer.innerHTML = "<p>Vänligen välj en användare från listan för att se deras inlägg.</p>";
      }
    }
    ...
    async function fetchUserPosts(userId, username) {
      ...
      try {
        ...
        postsContainer.innerHTML = "<p>Kunde inte hämta inlägg för den här användaren.</p>";
      }
    }
    ...
    function displayPosts(userId, posts, container) {
      ...
      if (posts.length === 0) {
        container.innerHTML = "<p>Inga inlägg hittades för den här användaren.</p>";
        return;
      }
      ...
      // The 'userPostsIds' object now holds arrays of post IDs for each user
      // whose posts have been viewed. You can access them like this:
      // userPostsIds[someUserId] -> returns an array of post IDs for that user.
    }
  });